...
color=4
node=x1.up}
B 2 940 -350 1730 -100 {flags=graph
y1=-0.023
y2=1.9
ypos1=0
ypos2=2
...
color=4
node=up_out}
B 2 940 -80 1730 170 {flags=graph
...
N 140 -1250 200 -1250 {
lab=VDD}
C {devices/code_shown.sym} -1830 -1900 0 1 {name=COMMANDS only_toplevel=true
value="
.ic v(x1.VCTRL_OBV)=0.25
*.option RSHUNT=1e18
**.option ABSTOL=1e-12
**.option VNTOL=1e-12
**.option CHGTOL=1e-14
...
C {devices/vsource.sym} -510 380 0 0 {name=V6 value="pulse(0 1.8 1000n 100p 100p 50n 100n)"}
...
C {devices/lab_wire.sym} -630 -870 0 0 {name=p60 sig_type=std_logic lab=VCTRL2}
...
C {devices/lab_wire.sym} -860 -670 0 0 {name=p22 sig_type=std_logic lab=D11}
...
C {devices/lab_wire.sym} -260 -650 3 0 {name=p104 sig_type=std_logic lab=DIV_OUT2}
