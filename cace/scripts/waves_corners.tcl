...
#set base_dir "~/analog_ip/cheetah_v3_analog/dependencies/sky130_sw_ip__bgrref_por/runs/Reg/rcx/Vmin"

#Define the tb_base_file_name 
#set tb_base_file_name "tran_sim_base_file.txt"
set tb_base_file_name "por_max_glitch_base_file.txt"
#set tb_base_file_name "por_min_glitch_base_file.txt"

#Define the signals you wish to plot
#set signals_to_plot {avdd "xdut.vinp xdut.vinn -" xdut.x1.vo xdut.x1.vo1 xdut.rst porb porb_h[0] por i(Vavdd) i(Vdvdd) i(v.xdut.Vrbranch) i(v.xdut.Vcomp) i(v.xdut.Vpulse) speedcheck}
#set signals_to_plot {"xdut.vinp xdut.vinn -" xdut.rst xdut.x2.td_sd xdut.x2.td_l xdut.x2.rstn porb porb_h[0]}
#set signals_to_plot {i(v.xdut.x1.Vself) i(v.xdut.x1.Vselfr) i(v.xdut.x2.Vbg_branch) xdut.x1.vbn xdut.x1.net6 xdut.x2.net9}
set signals_to_plot {avdd porb porb_h[0]}
#set signals_to_plot {porb xdut.x2.vbn1}
