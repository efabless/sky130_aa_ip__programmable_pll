...
N 1420 -360 1450 -360 {
lab=#net10}
C {devices/opin.sym} -400 -770 2 1 {name=p1 lab=OUT}
C {devices/iopin.sym} -350 -890 2 0 {name=p5 lab=VDD}
C {devices/iopin.sym} -350 -860 2 0 {name=p6 lab=VSS}
C {devices/opin.sym} -400 -740 2 1 {name=p7 lab=OUTB}
C {devices/ipin.sym} -400 -830 2 0 {name=p8 lab=VCTRL}
...
C {devices/ipin.sym} -410 -800 2 0 {name=p11 lab=VCTRL2}
C {devices/lab_pin.sym} 1800 -420 0 1 {name=p13 sig_type=std_logic lab=OUT}
C {devices/lab_pin.sym} 1860 -360 0 1 {name=p16 sig_type=std_logic lab=OUTB}
C {D-FF.sym} 1600 -390 0 0 {name=x10}
C {devices/lab_pin.sym} 1570 -490 0 0 {name=p30 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 1540 -280 0 0 {name=p35 sig_type=std_logic lab=VSS}
C {devices/title.sym} -790 0 0 0 {name=l1 author="AZEEM ABBAS"}
