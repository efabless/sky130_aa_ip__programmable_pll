...
C {devices/gnd.sym} -140 -190 0 0 {name=l7 lab=GND}
...
C {devices/isource.sym} 20 -160 0 0 {name=I4 value=20u}
C {devices/lab_wire.sym} 20 -210 0 0 {name=p5 sig_type=std_logic lab=VDD}
C {devices/isource.sym} -50 -150 2 0 {name=I2 value=20u}
